...
```css
/* Hover */
background-color: rgba(0, 0, 0, 0) → oklab(0.815954 -0.116777 -0.0864277 / 0.0417311);
border-color: oklab(0.815954 -0.116777 -0.0864277 / 0.4) → oklab(0.815954 -0.116777 -0.0864277 / 0.650386);
box-shadow: rgba(139, 92, 46, 0.6) 0px 0px 0px 2px, rgba(0, 0, 0, 0.8) 0px 0px 0px 3px, rgba(255, 255, 255, 0.15) 0px 2px 4px 0px inset, rgba(0, 0, 0, 0.4) 0px -2px 4px 0px inset, rgba(0, 0, 0, 0.6) 0px 6px 12px 0px → rgba(240, 172, 6, 0.77) 0px 0px 0px 2px, rgba(0, 0, 0, 0.8) 0px 0px 0px 3px, rgba(255, 255, 255, 0.235) 0px 2px 4px 0px inset, rgba(0, 0, 0, 0.486) 0px -2px 4px 0px inset, rgba(0, 167, 197, 0.43) 0px 0.992272px 18.677px 0px, rgba(0, 0, 0, 0.667) 0px 6.67697px 13.3539px 0px;
transform: none → matrix(1, 0, 0, 1, 0, -0.834621);
```
```css
/* Focus */
...
```css
/* Hover */
background-color: rgba(0, 0, 0, 0) → oklab(0.815954 -0.116777 -0.0864277 / 0.0347757);
border-color: oklab(0.815954 -0.116777 -0.0864277 / 0.4) → oklab(0.815954 -0.116777 -0.0864277 / 0.608654);
box-shadow: rgba(139, 92, 46, 0.6) 0px 0px 0px 2px, rgba(0, 0, 0, 0.8) 0px 0px 0px 3px, rgba(255, 255, 255, 0.15) 0px 2px 4px 0px inset, rgba(0, 0, 0, 0.4) 0px -2px 4px 0px inset, rgba(0, 0, 0, 0.6) 0px 6px 12px 0px → rgba(226, 161, 11, 0.737) 0px 0px 0px 2px, rgba(0, 0, 0, 0.8) 0px 0px 0px 3px, rgba(255, 255, 255, 0.22) 0px 2px 4px 0px inset, rgba(0, 0, 0, 0.47) 0px -2px 4px 0px inset, rgba(0, 131, 154, 0.463) 0px 1.82692px 17.5641px 0px, rgba(0, 0, 0, 0.557) 0px 5.56411px 11.1282px 0px;
transform: none → matrix(1, 0, 0, 1, 0, -0.695513);
```
```css
/* Focus */
background-color: rgba(0, 0, 0, 0) → oklab(0.815954 -0.116777 -0.0864277 / 0.05);
...
```css
/* Hover */
background-color: rgba(0, 0, 0, 0) → oklab(0.815954 -0.116777 -0.0864277 / 0.0347267);
border-color: oklab(0.815954 -0.116777 -0.0864277 / 0.4) → oklab(0.815954 -0.116777 -0.0864277 / 0.60836);
box-shadow: rgba(139, 92, 46, 0.6) 0px 0px 0px 2px, rgba(0, 0, 0, 0.8) 0px 0px 0px 3px, rgba(255, 255, 255, 0.15) 0px 2px 4px 0px inset, rgba(0, 0, 0, 0.4) 0px -2px 4px 0px inset, rgba(0, 0, 0, 0.6) 0px 6px 12px 0px → rgba(226, 161, 11, 0.737) 0px 0px 0px 2px, rgba(0, 0, 0, 0.8) 0px 0px 0px 3px, rgba(255, 255, 255, 0.22) 0px 2px 4px 0px inset, rgba(0, 0, 0, 0.47) 0px -2px 4px 0px inset, rgba(0, 131, 154, 0.463) 0px 1.83279px 17.5563px 0px, rgba(0, 0, 0, 0.557) 0px 5.55628px 11.1126px 0px;
transform: none → matrix(1, 0, 0, 1, 0, -0.694534);
```
```css
/* Focus */
background-color: rgba(0, 0, 0, 0) → oklab(0.815954 -0.116777 -0.0864277 / 0.05);
